...
namespace net.zemberek.bilgi.kokler
{
     ...
     * @param set Yurume sÄ±rasÄ±nda bulunan dÃ¼ÄŸÃ¼mler toplanmak istiyorsa buraya bir set gÃ¶nderilir.
...
/*            	if (dugum.getKelime() != null &&
    ...
    public String toString(){
        ...
        sb.Append("AltDugumu olanlarÄ±n dÃ¶kÃ¼mÃ¼: \n");
        int araToplam = 0;
        for(int i=1; i<30; i++){
